...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: "terceros", component: TercerosComponent, outlet: "contentClient" },
      { path: "terceros-create", component: TercerosCreateComponent, outlet: "contentClient" }
